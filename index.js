...
import { c, canvas, scaledCanvas } from './js/data/canvas.js';
...
const animate = () => {
	...
	if (keys.d.pressed) {
		...
		player.shouldPanCameraLeft({ scaledCanvasWidth: scaledCanvas.width, camera });
	...
	if (player.velocity.y < 0) {
		...
		player.shouldPanCameraUp({ scaledCanvasHeight: scaledCanvas.height, camera });
